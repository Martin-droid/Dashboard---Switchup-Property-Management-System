...
<div class="col-md-12">
  <form action= "{{route('new_services')}}" method="POST" style="margin-bottom: 20px;">
    @csrf
  <div id="form1">
  <div class="col-md-12">
...
<option value="Tanzania">Tanzania</option>
  ...
  <div class="form-group">
    ...
    <input type="email" name="city" class="form-control" placeholder="Enter City" style="padding-right: 50px;">
  ...
  <div class="form-group">
    ...
    <input type="email" name="address" class="form-control" placeholder="Enter Address" style="padding-right: 50px;">
