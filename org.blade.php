...
<div class="col-md-12">
  <form action= "{{route('new_org')}}" method="POST" style="margin-bottom: 20px;">
    @csrf
  <div id="form1">
  <div class="col-md-12">
...
<option value="Tanzania">Tanzania</option>
 ...
 <div class="col-md-12" >
  <div class="form-group">
    <label>City</label>
    <input type="text" name="city" class="form-control" placeholder="Enter City" style="padding-right: 50px;">
 ...
 <div class="col-md-12" >
  <div class="form-group">
    ...
    <input type="text" name="address" class="form-control" placeholder="Enter Address" style="padding-right: 50px;">
...
<div class="container">
  ...
  <div class="row" style="padding-top: 10px; font-size: 13px;">
    ...
    <table class="table" id="table2" style="justify-content: center; text-align:center;">
      <thead>
