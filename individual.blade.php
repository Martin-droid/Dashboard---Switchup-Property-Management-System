...
<div class="wrapper">
  ...
  <li class="nav-item">
            <a href='/unittype' class="nav-link">
...
<div class="content-wrapper">
  ...
  <div class="col-md-12">
    <form action= "{{route('new_individual')}}" method="POST" style="margin-bottom: 20px;">
      @csrf
    <div id="form1">
    <div class="col-md-12">
  ...
  <option value="Tanzania">Tanzania</option>
    ...
    <div class="form-group">
      ...
      <input type="email" name="county" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter County">
    ...
    <div class="form-group">
      ...
      <input type="email" name="city" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter City" style="padding-right: 50px;">
    ...
    <div class="form-group">
      ...
      <input type="email" name="idtype" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID Type" style="padding-right: 50px;">
    ...
    <div class="form-group">
      ...
      <input type="email" name="idnumber" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID Number" style="padding-right: 50px;">
...
<table class="table" style="justify-content: center; text-align:center;">
  ...
  <tbody>
   @foreach($individuals as $persons)
   <tr>
     <td>#</td>
     <td>{{$persons->fname}}</td>
     <td>{{$persons->lname}}</td>
