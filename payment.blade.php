...
<div class="col-md-12">
  <form action= "{{route('new_payment')}}" method="POST" style="margin-bottom: 20px;">
    @csrf
  <div id="form1">
  <div class="col-md-12">
  ...
  <div class="form-group">
    ...
    <input type="email" name="description" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Description">
